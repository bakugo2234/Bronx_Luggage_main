...
if (!isset($_SESSION['csrf_token'])) {
    ...
    error_log("CSRF Token created: " . $_SESSION['csrf_token']);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (isset($_SESSION['csrf_token_time']) && (time() - $_SESSION['csrf_token_time'] > 1800)) {
        $error = "Lỗi bảo mật: CSRF token đã hết hạn!";
