    ...
    <div class="ml-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p><strong>Nội Dung Chuyển Khoản:</strong> Thanh toán đơn hàng #<?php echo htmlspecialchars($order['id'] ?? 'N/A'); ?></p>
                <p class="text-red-500 mt-2">Vui lòng chuyển khoản số tiền <strong><?php echo number_format($order['total_money'] ?? 0, 2); ?> VNĐ</strong> để hoàn tất đơn hàng.</p>
            </div>
